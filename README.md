...
--- |:---
create a .env file with `KEY='your_password_of_choice'` | fill in your GoPro password in `=your_password` where it is indicated bellow make sure it looks like this `camera = GoProHero(password='your_password_of_choice')` including the`*`*`
